    ...
    return (
        <div className="float-left w-[25%] space-y-16">
            <div className="sort text-white flex flex-col space-y-5 m-5">
                ...
                <select
                    name="Sort"
                    className="bg-black mx-16 text-center rounded-2xl p-3"
                    id="sort"
                    onChange={settingSort}
                >
            ...
            <div className="filter text-white flex flex-col space-y-5 m-5 float-none justify-center text-center" >
                ...
                <select name="filter" className='bg-black mx-16 text-center rounded-2xl p-3' id="filter" onChange={setPrice}>
